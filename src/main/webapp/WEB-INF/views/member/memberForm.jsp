	...
	$("#btnidCheck").click(function(){
		if($("input[name=mem_id]").val()){
			...
			$.ajax({
				...
				if(data.result == "true"){
					$("#resultMsg").text("사용중인 아이디입니다.");
				}else{
					duplicateCheck = true;
					$("#resultMsg").text("사용가능 아이디입니다.");
				}
			...
			<table class="table table-bordered">
				<tr>
					...
					<td><input type="text" name="mem_id" size="20"
						value="${member.mem_id}">
						<button type="button" class="btn btn-primary" id="btnidCheck">중복체크</button> 8~20자
						내의 영문,숫자 조합
				...
				<tr>
					...
					<td><input type="text" name="mem_name" size="20"
						value="${member.mem_name}"> 실명을 입력하세요</td>
				</tr>
				<tr>
					<td>비밀번호</td>
					<td><input type="password" name="mem_pwd" size="20">
						8~20자 내의 영문,숫자 조합</td>
				</tr>
				<tr>
					<td>비밀번호확인</td>
				...
				<tr>
					...
					<td><input type="text" name="mem_birth" size="20"
						value="${member.mem_birth}"> 예) 19931231</td>
				</tr>
				<tr>
					<td>전화번호</td>
					<td><input type="text" name="mem_phone" size="20"
						value="${member.mem_phone}"> '-' 없이 입력</td>
				</tr>
				<tr>
					<td>이메일</td>
				...
				<tr>
					...
					<td>
						<p>
							<input type="text" name="mem_zipcode" size="6"
				...
				<tr>
					<td colspan="2"><c:if test="${param.type == 'I'}">
							<input type="button" value="가입하기" class="btn btn-default"
								onclick="fn_save('I')">
						</c:if> <c:if test="${param.type != 'I'}">
